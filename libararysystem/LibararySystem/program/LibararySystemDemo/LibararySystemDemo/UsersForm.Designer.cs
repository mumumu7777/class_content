namespace LibararySystemDemo
{
	partial class UsersForm
	{
		...
		private void InitializeComponent()
		{
			...
			// addNewButton
			// 
			this.addNewButton.Location = new System.Drawing.Point(350, 67);
			...
			// 
			this.userIndexVMBindingSource.DataSource = typeof(LibararySystemDemo.model.dataindex.UserIndexVM);
			// 
