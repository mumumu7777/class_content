namespace LibararySystemDemo
{
	partial class CreatBookCategory
	{
		...
		private void InitializeComponent()
		{
			...
			// categorycombobox
			// 
			this.categorycombobox.DataSource = this.bookClassIndexViewBindingSource;
			this.categorycombobox.DisplayMember = "Class";
			this.categorycombobox.FormattingEnabled = true;
			this.categorycombobox.Location = new System.Drawing.Point(177, 300);
			this.categorycombobox.Name = "categorycombobox";
			this.categorycombobox.Size = new System.Drawing.Size(121, 20);
			this.categorycombobox.TabIndex = 1;
			this.categorycombobox.ValueMember = "Class";
			// 
			...
			// SaveBtn
			// 
			this.SaveBtn.Location = new System.Drawing.Point(177, 354);
